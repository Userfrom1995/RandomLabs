...
- **Dynamic Infrastructure Validation**:
  ...
  3. Execute `.github/scripts/silent-stall-audit.sh` to ensure all silent-stall invariants (`R1`-`R11`) and non-cancelling concurrency rules remain intact.
