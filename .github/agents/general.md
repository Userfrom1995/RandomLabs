...
- Never remove or overwrite: README.md's first section (repo overview), the
  ...
  feature in `pages.yml`, or the lab infrastructure (`.github/agents/`,
  the lab workflows, LAB.md) without a clear request.
...
For repo-specific context (the lab, agents, commands):
`LAB.md` (architecture), `AGENTS.md` (operating rules), and
