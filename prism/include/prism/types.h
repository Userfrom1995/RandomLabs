...
struct Feature {
    ...
    u8  parent_mag = 0;    // quantized parent wavelet coeff magnitude, 0..7 (PropId 14)
    u8  grandparent_mag = 0; // quantized grandparent wavelet coeff magnitude, 0..7 (PropId 15)
};
