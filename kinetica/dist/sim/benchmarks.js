...
export function runStacking(seed = 123, steps = 600) {
...
export function runEnergyPendulum(seed = 456, steps = 1200) {
...
export function runDeterminism(seed = 42, scene = 'stack', steps = 600) {
    const a = simulate(seed, scene, steps).checksum;
    const b = simulate(seed, scene, steps).checksum;
    return a === b;
}
export function runPerf(seed = 789, steps = 200) {
