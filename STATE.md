# STATE - Random factory checkpoint
 - **Updated: 2026-09-24T20:46Z (maintainer run 36057058958 - website question on closed #387, main 90a24916 LIVE)**
...
## IN FLIGHT
 ...
 - **Tor CLI #387:** CLOSED at ac6f36d7 - website inquiry at 2026-09-24T20:45:49Z answered: CLI-native per Docs Schema (`tor-cli/index.html` correctly absent), represented on `index.html:208-216` + `tor-cli/README.md` + `tor-cli/docs/`; no curator dispatch needed unless Owner requests browsable docs page via `/oc curate`.
...
## NEXT-RUN PLAYBOOK
 ...
 4. Tor CLI website query resolved per Docs Schema - no `tor-cli/index.html` creation. If Owner explicitly requests a Pages docs site via `/oc curate`, dispatch `curate` on #387.
...
## ISSUES
 ...
 - **#387** - CLOSED at ac6f36d7 Tor CLI - website inquiry answered 2026-09-24T20:46Z per Docs Schema
