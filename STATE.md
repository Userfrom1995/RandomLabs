# STATE - Random factory checkpoint
 - **Updated: 2026-09-23T07:17Z (maintainer run 35830794330 workflow_run failure triage on opencode-review failure 35830761078, main c013fe0 LIVE, M2 PR #380 at 83c46b8 auto-retry 1 in_progress)**
 - **Action this run:** `[]` - Stand down: opencode-review run 35830761078 on PR #380 failed at Get opencode version (curl) with no decision file, crash-parity auto-retry posted `/oc review (auto-retry 1)` at 07:15:38Z (comment 5790673714), new run 35830787689 now in_progress (Run opencode reviewer started 07:16:00Z). Within 30m cooldown for same workflow+branch signature; no duplicate dispatch to avoid flap.
 ...
 - **Branch retention:** `opencode/issue375-20260922160615` at 29344ffe MERGED to c013fe0 (retained per #148); `opencode/issue375-umbra-m2` at 83c46b8 (5 commits 4fc53691..83c46b8) OPEN as PR #380; `opencode/issue375-20260922165246` at 0b16d0be stale lab deletion branch (retained, not merged to main)
---

## STANDING OWNER DIRECTIVES (active)
 - **UMBRA DIRECTIVE (2026-09-22T15:43Z, via #375 OPEN):** Lab Directive Autonomous End-to-End Build of Shadow Fight-inspired WebGPU Combat Game at `/umbra/` - 7 binding gates. Blueprint `ideas/2026-09-22-umbra-shadow-fight-webgpu-combat.md` + `progress/375-umbra.md` (M1-M5, Status: in-progress, Active Milestone: M2, Refs intermediates). PR #376 M1 MERGED at c013fe0 (9.8/10), M2 PR #380 OPEN at 83c46b8 -> review (auto-retry 1 in_progress).
...
## CRITICAL INFRASTRUCTURE STATE
 ...
 - **Pages/PR preview:** Deploy success 35816077844 workflow_dispatch on c013fe0; PR #380 preview staging via preview/pr-380/ after review dispatches; opencode-review auto-retry path healthy (crash-parity working).
---
...
## IN FLIGHT
 ...
 - **Umbra #375 OPEN - M2 PR #380 at 83c46b8 (REVIEW auto-retry 1 in_progress):** Blueprint + `progress/375-umbra.md` on main at c013fe0 (M1 [x] Complete Refs, M2-M5 [ ] unchecked, Status: in-progress, Active: M2 deterministic combat engine + universal input, Refs intermediates). Branch `opencode/issue375-umbra-m2` at 83c46b8 (5 commits 4fc53691 headless combat + 7ce6b00b input + 0c73e719 poses/scene + ad31118b fight shell + 83c46b8 docs, merge-base c013fe0 linear) pushed, PR #380 OPEN 07:10:47Z MERGEABLE CLEAN, opencode-review 35830761078 failed at version fetch (no decision), auto-retry 1 posted 07:15:38Z, new run 35830787689 in_progress since 07:16:00Z; next Reviewer -> Tester -> Evaluator >=9.8 per milestone.
 - **Open PRs:** [380 Umbra M2 at 83c46b8 MERGEABLE CLEAN Refs #375 -> review auto-retry 1 in_progress 07:16Z]
 - **Open issues:** #375 Umbra (M2 review retry) + #70 lab-health + #42 brainstorm.
...
## PIPELINE POSITION
 Doom M1 REJECT 5.3 -> fix -> APPROVE 9.84 -> MERGE -> M2 8.0 -> fix -> 9.8 MERGE -> M3 fix NaN -> 9.86 MERGE -> M4 9.88 MERGE -> M5 MERGED at e33e11f1, Doom epic COMPLETE + Evaluator bootstrap at 5f15cef6 + Lab fixes at 0b16d0be 16/16 PASS + eval wiring at 1ff6eb09 + checkout mirror at 94991020 + eval loop+impersonation fix at 51c719c SUCCESS + Umbra M1 9.8/10 MERGED at c013fe0. **Current: main c013fe0 LIVE, 16/16 PASS + eval 9.8, M2 PR #380 at 83c46b8 auto-retry 1 in_progress 07:16Z, awaiting Reviewer verdict before Tester -> Evaluator.**
---

## NEXT-RUN PLAYBOOK
 1. Verify Reviewer `opencode-review` run 35830787689 on PR #380 at 83c46b8 completes: if `/oc fix` -> route Fixer, if `/oc approve` -> chain Tester `{"action":"test","pr":380}` immediately; if it fails again (no decision file) -> allow auto-retry 2/3 within cap, only dispatch manual `review` if cap exceeded.
 2. After Tester `/oc approve-test` on same head 83c46b8, chain Evaluator `{"action":"eval","pr":380}` for binding >=9.8; keep #375 OPEN until M5 (Refs #375, never Closes mid-epic).
 ...
 4. Verify Deploy success remains on c013fe0 and PR-preview staging for PR #380; sweep only if stuck.
 5. Keep trigger-list 16/16 PASS and two-knob free verified each run; no lab dispatch needed unless drift reappears.

## ISSUES
 - **#375** - OPEN Umbra (M1 MERGED at c013fe0 9.8/10, M2 PR #380 at 83c46b8 -> review auto-retry 1 in_progress 07:16Z)
 - **#376** - MERGED at c013fe0 03:51:27Z (M1 scaffold + render tiers + offline shell, Refs #375)
 - **#380** - OPEN at 83c46b8 07:10:47Z (M2 combat+input, Refs #375, awaiting Reviewer retry)
 - **#70** - OPEN lab-health (16/16 PASS + Deploy success 35816077844, monitoring)
 - **#42** - OPEN brainstorm (standby, no auto-pick)
---

## OPEN QUESTIONS
 - Will M2 PR #380 at 83c46b8 achieve Reviewer + Tester + Evaluator >=9.8 on first pass or need surgical Fixer hardening (hitboxes/block/parry/dodge, combos+scaling, AI tier1, input remapping persisted)? Auto-retry 1 now in_progress after transient version-fetch failure.
