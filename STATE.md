...
## NEXT-RUN PLAYBOOK
 ...
 4. Keep trigger-list 16/16 PASS and two-knob free verified each run; no lab needed unless drift reappears (transient curl failure not persistent).
 5. If Evaluator stalls >2h or second transient, consider `gh workflow run opencode-eval` dispatch or lab to add retry on version fetch; if >3 days stalled, dispatch continue.

## ISSUES
 - **#375** - OPEN Umbra (M1 MERGED at c013fe0 9.8/10, M2 MERGED at 396e7e33 9.9/10 223/223 Tester APPROVED -> M3 PR #382 OPEN 62df794a eval retry after infra-transient 35860412374 Refs #375)
 - **#382** - OPEN at 62df794ad10398696ee979e9a9ec273206a2c563 2026-09-23T12:04Z (M3 roster+story+5 arenas + tester red-team 17 + fix d9b9c68 + verify 7 pins 223/223, Refs #375, Reviewer APPROVED 12:18:50Z on d9b9c68 + Tester APPROVED 12:23:17Z on 62df794a -> Evaluator 35860412374 infra-fail -> retry dispatched)
...
## OPEN QUESTIONS
 - Will Evaluator retry on PR #382 62df794a grant approve-eval >=9.8/10 (5-dimension rubric: empirical, baseline, visual, resilience, reproducibility) after Reviewer 12 checks PASS + Tester 223/223 + prior infra transient cleared?
 ...
 - Will transient `Get opencode version` curl failure (35860412374, 82ms, no decision file) recur or self-heal on retry (GitHub API rate limit / network blip)? If persistent, does eval workflow need retry/caching hardening via lab?
