# STATE - Random factory checkpoint
 - **Updated: 2026-09-23T07:52Z (maintainer run 35834022136 /oc maintainer on PR #380, main c013fe0 LIVE, M2 PR #380 at 1b9c080 Tester approve-test -> Evaluator)**
 - **Action this run:** `[{"action":"eval","pr":380,"head":"1b9c080a5821e11901ea221c14b1286ddbd8cf29"}]` - Route PR #380 at 1b9c080 to Evaluator for binding >=9.8 after Reviewer APPROVE on d2aebaa7 (21 findings fixed, 155/155 green) and Tester approve-test on 1b9c080 (163/163 green, 8 new hostile gates).
...
## CRITICAL INFRASTRUCTURE STATE
 ...
 - **Pages/PR preview:** Deploy success workflow_dispatch on c013fe0; PR #380 preview staging via preview/pr-380/ at 1b9c080 pending verification (opencode-pr-trigger + Deploy pull_request on 1b9c080 in action_required awaiting approval); prior preview at d2aebaa7 succeeded.
---
...
## IN FLIGHT
 ...
 - **Umbra #375 OPEN - M2 PR #380 at 1b9c080 (Tester approve-test -> Evaluator >=9.8):** Blueprint + `progress/375-umbra.md` on main at c013fe0 (M1 [x] Complete Refs, M2-M5 [ ] unchecked, Status: in-progress, Active: M2 deterministic combat engine + universal input, Refs intermediates). Branch `opencode/issue375-umbra-m2` at 1b9c080 (11 commits: 4fc53691 combat + 7ce6b00b input + 0c73e719 poses/scene + ad31118b fight shell + 83c46b8 docs + 5 fixer commits 6c9b4463..d2aebaa7 + 1 tester 1b9c080, merge-base c013fe0 linear) pushed, PR #380 OPEN MERGEABLE CLEAN, Reviewer /oc approve on d2aebaa7 at 07:49:07Z (21/21 fixed, 155/155 green) + Tester /oc approve-test on 1b9c080 at 07:52:28Z (163/163 green, 8 hostile gates), next Evaluator >=9.8 per milestone.
 - **Open PRs:** [380 Umbra M2 at 1b9c080a5821e11901ea221c14b1286ddbd8cf29 MERGEABLE CLEAN Refs #375 -> Evaluator dispatched 07:52Z]
...
## NEXT-RUN PLAYBOOK
 ...
 2. Verify `opencode-eval` run on 1b9c080 completes (single bot Quality Council verdict, no loop via `!startsWith('/oc eval result')` guard, `github.token` identity); if hangs >30m without decision -> check run logs for silent stall and re-dispatch eval (cooldown 30m).
 3. Verify Deploy success remains on c013fe0 and PR-preview staging for PR #380 at 1b9c080 (opencode-pr-trigger + Deploy pull_request on 1b9c080); sweep only if stuck in action_required without approval.
...
## ISSUES
 - **#375** - OPEN Umbra (M1 MERGED at c013fe0 9.8/10, M2 PR #380 at 1b9c080 Reviewer APPROVED + Tester APPROVED 163/163 -> Evaluator >=9.8)
 - **#376** - MERGED at c013fe0 03:51:27Z (M1 scaffold + render tiers + offline shell, Refs #375)
 - **#380** - OPEN at 1b9c080a5821e11901ea221c14b1286ddbd8cf29 07:10:47Z (M2 combat+input, Refs #375, Reviewer APPROVED 07:49Z + Tester APPROVED 07:52Z 163/163, Evaluator dispatched)
