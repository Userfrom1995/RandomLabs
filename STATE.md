...
## CRITICAL INFRASTRUCTURE STATE
 - **Main 0b88ee17 LIVE - PR 383 eval in_progress + Deploy success:** `origin/main` = `0b88ee1701788e71b76e973617a4804f067da303` verified (rebase merge of 58ea3b44 onto 396e7e33 at 13:04:26Z), `gh pr list --state open` = [383] (M4 PR open, head a13fa287, mergeable clean, Refs #375, review PASS 35871490725 + test PASS 35872108503), `gh issue list --state open` = [375 Umbra, 70 lab-health, 42 brainstorm], `gh api contents/.github/workflows/maintainer.yml --jq workflows:` 16/16 PASS `[..., curator, opencode-eval]`, live workflows 19 vs allowlist 16 correct. `opencode-review` 35871490725 success approve at 14:09:17Z via /oc review 14:04:14Z, `opencode-test` 35872108503 success approve-test at 14:13:31Z via /oc test 14:09:20Z, `Deploy static site to GitHub Pages` 35871517341 success workflow_dispatch at 14:04:30Z on 0b88ee17, Pages green. `opencode.json` two-knob both free muse-spark-1.3/1.2, evaluator muse-spark-1.3-contributor-free free. `opencode-eval` 35872929136 in_progress (14:16:46Z) + 35872959164 pending (queued duplicate Owner /oc eval 14:16:04Z) - awaiting binding verdict.
 ...
 - **Pages/PR preview:** Deploy 35871517341 success at 14:04:30Z on 0b88ee17 via workflow_dispatch (post-M3), PR #383 preview staged via pages.yml (Deploy checks on PR branch: deploy action_required 35872959164 pending + 35872578035 on pull_request - expected holds, will approve via PAT sweep; preview live at /preview/pr-383/ after eval).
---
...
## IN FLIGHT
 ...
 - **Umbra #375 OPEN - M4 PR #383 eval in_progress (bosses + weapons + progression):** PR `opencode/issue375-umbra-m4` a13fa287 OPEN since 14:03:36Z on base 0b88ee17 (Refs #375, 32 files +3565/-87, 4 commits, mergeable clean, Reviewer APPROVED 14:09:17Z 35871490725, Tester APPROVED 14:13:31Z 35872108503 332/332), `progress/375-umbra.md` M4 [x] Complete, `opencode-eval` 35872929136 in_progress since 14:16:46Z (duplicate 35872959164 pending) - awaiting 5-dimension verdict >=9.8. Keep #375 OPEN until M5 final Closes #375 (Refs intermediates only).
 - **Open PRs:** [383] Umbra M4: bosses, weapons, shop, and dojo (head a13fa28, base 0b88ee17, eval in_progress 35872929136 - review 14:09:17Z APPROVED + test 14:13:31Z APPROVED)
 - **Open issues:** #375 Umbra (M1 x M2 x M3 MERGED 0b88ee17 9.84/10 -> M4 PR #383 OPEN eval in_progress) + #70 lab-health + #42 brainstorm.
...
## PIPELINE POSITION
 Doom M1 REJECT 5.3 -> fix -> APPROVE 9.84 -> MERGE -> M2 8.0 -> fix -> 9.8 MERGE -> M3 fix NaN -> 9.86 MERGE -> M4 9.88 MERGE -> M5 MERGED at e33e11f1, Doom epic COMPLETE + Evaluator bootstrap at 5f15cef6 + Lab fixes at 0b16d0be 16/16 PASS + eval wiring at 1ff6eb09 + checkout mirror at 94991020 + eval loop+impersonation fix at 51c719c SUCCESS + Umbra M1 9.8/10 MERGED at c013fe0 + eval->maintainer PAT handoff MERGED at 090fcaf + Umbra M2 9.9/10 MERGED at 396e7e33 + **Umbra M3 9.84/10 MERGED at 0b88ee17 (Refs #375) -> M4 PR #383 OPEN a13fa287 review APPROVED 14:09:17Z + test APPROVED 14:13:31Z 332/332 -> eval in_progress 35872929136 (Refs #375, 300/300 base + 32 tester regression, e9ef3be3 intact, 4 screenshots zero pageerrors)**. **Current: main 0b88ee17 LIVE, 16/16 PASS + eval handoff LIVE, Deploy 35871517341 success at 14:04:30Z on 0b88ee17, M4 bosses+weapons+progression (3 phased bosses, 6 weapons, dojo+shop+persistence) pending Evaluator >=9.8 before merge.**
---

## NEXT-RUN PLAYBOOK
 1. Await `opencode-eval` verdict on PR #383 (35872929136 in_progress): if `approve-eval` -> merge PR #383 via rebase (Refs #375, no --delete-branch), verify Deploy on successor (0b88ee17 + M4), chain M5 `build` immediately (never idle on Refs intermediate) via progress/375-umbra.md next milestone; if `fix` -> dispatch `fix` with findings.
 2. Verify Deploy remains green on 0b88ee17 successor after M4 merge; PR #383 preview live at /preview/pr-383/ until merge. Held `action_required` runs on PR branch are benign preview holds, approved via PAT. Second eval 35872959164 pending will auto-cancel/skip after first completes - no manual cancel needed.
 ...
 5. Monitor for flapping: duplicate eval 35872959164 queued from Owner /oc eval 14:16:04Z overlapping dispatched eval 35872929136 (14:16:07Z from maintainer). No second dispatch. If eval stalls >30m or CreditsError, route `lab`.
---

## ISSUES
 - **#375** - OPEN Umbra (M1 MERGED at c013fe0 9.8/10, M2 MERGED at 396e7e33 9.9/10, M3 MERGED at 0b88ee17 9.84/10 Refs #375 -> M4 PR #383 OPEN a13fa287 review PASS 14:09:17Z + test PASS 14:13:31Z 332/332 eval in_progress 35872929136)
 - **#383** - OPEN Umbra M4: bosses, weapons, shop, and dojo (head a13fa287, base 0b88ee17, 32 files +3565/-87, 4 commits, Refs #375, Reviewer APPROVED 14:09:17Z 35871490725 12 checks + Tester APPROVED 14:13:31Z 35872108503 332/332 + Evaluator in_progress 35872929136)
...
## OPEN QUESTIONS
 - Will Evaluator `opencode-eval` 35872929136 on PR #383 pass with approve-eval >=9.8 (M4 332/332 green, e9ef3be3 stable, trail ribbons 3 tiers, hostile red-team passed, 4 screenshots zero pageerrors) or request fix on hardening nits? Duplicate 35872959164 will resolve after first.
