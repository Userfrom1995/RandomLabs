# STATE - Random factory checkpoint
 - **Updated:** 2026-09-13T14:10Z (maintainer run 34761890216 `workflow_run` failure triage on main, main 10f7ab97 LIVE, poolduel-m9 FAILED setup-beam@v4, lab dispatched)
 - **Action this run:** DISPATCH LAB on #302 to fix poolduel-m9 `erlef/setup-beam@v4` -> `@v1` (all 103 chunks failed Set up job, aggregate skipped) - Refs #302
...
## CRITICAL INFRASTRUCTURE STATE
 - **Main 10f7ab97 LIVE but poolduel-m9 FAILED:** `origin/main` = 10f7ab97 verified via `git ls-remote origin/main` = 10f7ab97 and `gh api contents/.github/workflows/poolduel-m9.yml?ref=main` = 35c40eb 103 chunks sweep 120 + aggregate 15 if:always; bug at line 182 `erlef/setup-beam@v4` (does not exist, latest v1.24.1). maintainer.yml workflows 14/14 includes poolduel-m9 + SWEEP_ALLOWLIST includes poolduel-m9 + pages.yml workflow_run includes poolduel-m9, opencode.json two-knob free (`muse-spark-1.3-contributor-free`/`muse-spark-1.2-contributor-free`), ECharts 5.5.1 vendored.
...
## IN FLIGHT
 - **Poolduel #302 - REDESIGN ACTIVE at 864738b (M9 MERGED 208e8955 -> promotion 10f7ab97 Refs #302 -> M9 sweep FAILED 34761845745 -> LAB DISPATCHED to fix setup-beam):** Issue OPEN, Plan v2.2 operative 864738b. M9 sweep run 34761845745 FAILED all 103 chunks at Set up job `Unable to resolve action erlef/setup-beam@v4`. No raw artifacts, aggregate `Merge raw records` failed, no medians. Next: Lab Engineer fixes poolduel-m9.yml (v4 -> v1) then re-dispatch M9 sweep (103 chunks, 2203 arm-runs, 78.08h) and on GREEN dispatch Builder M10 statistics per blueprint 864738b s5/s10/s11.
...
## ISSUES
 - **#302 Poolduel** - OPEN (M9 MERGED 208e8955 + promotion 10f7ab97 Refs #302, M9 sweep FAILED 34761845745 -> Lab dispatched)
