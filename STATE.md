# STATE - Random factory checkpoint
 - **Updated:** 2026-08-26 (~11:47Z, maintainer run 32963771899 issue_comment on PR #146 `/oc maintainer` - Q1 T1a/T1b engine at 12e6c64, quiet watch)
...
- **main = 14bd9e6cd64b45ec3467e25098f806fd12d65174 LIVE** (ls-remote verified 11:47Z, PAT sweep 442 live, 632 lines).
- **Model:** opencode/x-preview-f-free (model) + opencode/muse-spark-1.2-contributor-free (small_model) per opencode.json; all workflows on free pins. Builder Q1 run 32960938814 (`/oc continue` dispatched 11:03:43Z, started 10:58:21Z) still in_progress at 11:47Z, already pushed fdf6525 (11:16Z Q1 pins P-Q1-1..9), 483e978 (11:22Z per-plane group_base repair), and 12e6c64 (bench-sandbox --t1a/--t1b engine with TSUM decomposition, 461 lines in prism/src/cli/main.cpp) - opencode-pr-trigger + pages on 12e6c64 are action_required hold, not CLEAN; branch now 12e6c64 MERGEABLE.

## IN FLIGHT
- **PR #146** - OPEN head `12e6c64fe1653c64d53f7714ba1e2f0986df9805` (`opencode/issue130-20260826070009`, base 14bd9e6c, MERGEABLE, ahead 19 / behind 0). Deliverables: `research-v3-content-clustering.md`, `architecture-jxl-parity-tseries.md` (T-series blueprint), `algorithmic-spec.md` addendum 20, `progress/130-prism-true-jxl-parity.md` T-series checklist T0 [x] DONE Q0 COMPLETE 2026-08-26 (reconciled A-T0-1+A5, 142/142, T0 CSV committed), Q1 pins P-Q1-1..P-Q1-9 committed BEFORE any T1a row (per-plane ClusterMap group_base repair), Q1 engine 12e6c64: bench-sandbox --t1a (CEILING KGROUP64/128 x 7 trials, gate >=+2.00 median NET, sole-tables-loss wholesale, transmitted-table coding) + --t1b whole-K codebooks (K=4,8,16,24) with TSUM decomposition (tables_bytes/paygain/sole) beside T-BASE. Next: T1a quad measurement --t1a against fresh T-BASE on Kodak, CSV `benchmarks/results/2026-08-26-sandbox-t1a.csv` pending. Zero container bytes until T4. Builder run 32960938814 still in_progress building T1a measurement.
...
4. Honesty: never claim T1a PASS or M2/M3 PASS until quad measurement vs fresh T-BASE proves it with decomposition audit. `action_required` on 12e6c64 is PR-trigger/pages hold, not a merge block - still await T1a CSV before any review/test.

## ISSUES
- **#130** - Prism v3 T-series ACTIVE (T0 COMPLETE, Q1 pins+repair+engine COMPLETE at 12e6c64, T1a measurement in_progress).
- **#146** - OPEN 12e6c64 MERGEABLE (TRIGGER hold), blueprint+addendum 20+T0 COMPLETE, Q1 engine landed, T1a pending measurement.
