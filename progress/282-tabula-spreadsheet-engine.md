...
- [ ] builder 0: de-risk (`Package.swift`, TabulaCore skeleton, `swift test` green, `carton build` hello-grid through Bridge batch, JavaScriptKit pin recorded)
...
## Next steps
- Builder proves Phase 0 on this branch (toolchain pins plus hello-grid evidence in `tabula/docs/architecture.md`), then implements Phases 1 through 5 in order on the same PR across `continue` cycles.
